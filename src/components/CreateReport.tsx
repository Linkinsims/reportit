...
export function CreateReport({ profile, org, onNavigate }: Props) {
  ...
  const attachPhoto = useMutation(api.reports.attachPhoto);
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Fill in the details below to submit a report</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border p-6 space-y-5">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">Date & Time of Incident <span className="text-red-500">*</span></label>
          <input
            type="datetime-local"
            required
            className="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ...
        <div>
          ...
          >
            ...
            <p className="text-sm text-gray-500">Click to upload images or documents</p>
